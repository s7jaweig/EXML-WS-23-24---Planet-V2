...
### Usage
	...
	* Run the Planet with the images generated in the step before. Fot this, run PlaNet.ipynb in /Network
	  with the function for Superpixels (Cell 4)		
	* The results are needed to run "Visualize_Planet_Output.py". Parameters can be
